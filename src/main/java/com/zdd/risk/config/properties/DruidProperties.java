...
public class DruidProperties {
    ...
    private String url = "jdbc:mysql://192.168.244.206:3306/guns?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull";

    private String username = "debian-sys-maint";

    private String password = "zwVgAacL3PDYSQQB";
