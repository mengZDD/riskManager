...
import com.zdd.risk.modular.system.dao.DictDao;
import com.zdd.risk.modular.system.service.IDictService;
import com.zdd.risk.modular.system.warpper.DictWarpper;
import com.zdd.risk.common.persistence.dao.DictMapper;
import com.zdd.risk.common.persistence.model.Dict;
...
public class DictController extends BaseController {
     ...
     */
    @BussinessLog(value = "添加字典记录", key = "dictName,dictValues", dict = com.zdd.risk.common.constant.Dict.DictMap)
     ...
     * 修改字典
     */
    @BussinessLog(value = "修改字典", key = "dictName,dictValues", dict = com.zdd.risk.common.constant.Dict.DictMap)
     ...
     * 删除字典记录
     */
    @BussinessLog(value = "删除字典记录", key = "dictId", dict = com.zdd.risk.common.constant.Dict.DeleteDict)
